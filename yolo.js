...
export async function loadModel(modelPath) {
  ...
  _sessionPromise = (async () => {
    ...
    if (typeof fetch !== "undefined" && (resolvedPath.startsWith("chrome-extension:") || resolvedPath.startsWith("moz-extension:") || resolvedPath.startsWith("http") || resolvedPath.startsWith("blob:"))) {
